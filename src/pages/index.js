...
const Home = () => {
    return (
        <>
            ...
            <div className="grid grid-cols-2 gap-10 m-10 font-semibold text-4xl">
                <div className="col-span-2 bg-gray-200 p-40 rounded-3xl hover:bg-gray-300">All Work in One Place, Anywhere</div>
                <div className=" bg-gray-200 p-40 rounded-3xl hover:bg-gray-300">Auto Optimized Inbox</div>
